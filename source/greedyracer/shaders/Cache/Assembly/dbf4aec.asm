...
ld_indexable(buffer)(uint,uint,uint,uint) r9.w, r1.wwww, t4.yzwx
movc r5.w, r5.w, r9.z, r9.w  // uNumLights<0>
...
loop 
  ...
  ult r9.w, r9.z, r9.w
  breakc_z r9.w
  ld_indexable(buffer)(uint,uint,uint,uint) r9.w, r9.zzzz, t4.yzwx  // uLightIndex<0>
...
#line 204
    ...
    div r11.w, r13.w, r11.w  // fFallOff<0:NaN:Inf>
    ld_indexable(buffer)(float,float,float,float) r18.xyz, r10.wwww, t3.xyzw
    dp3 r13.w, r17.yzwy, r14.xyzx
    max r13.w, r13.w, l(0.000000)
    min r13.w, r13.w, l(1.000000)
    mul r19.xyz, r13.wwww, r18.xyzx
    mul r19.xyz, r11.wwww, r19.xyzx  // f3LightColorDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 8 "ggxlighting.h"
    ...
    rsq r15.w, r15.w
    mul r20.xyz, r15.wwww, r20.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r13.w, r13.w, r13.w  // fAlpha<0:Inf:[0f,1.#INFf]>
    add r21.xyz, r13.xyzx, r15.xyzx
    dp3 r15.w, r21.xyzx, r21.xyzx
    rsq r15.w, r15.w
    mul r21.xyz, r15.wwww, r21.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r15.w, r20.xyzx, r13.xyzx
    max r15.w, r15.w, l(0.000000)
    min r15.w, r15.w, l(1.000000)  // fDotNL<0:[0f,1f]>
...
#line 21
    mul r13.y, r13.w, r13.w  // fAlphaSqr<0:NaN:Inf>
...
#line 27
    ...
    add r13.x, r13.x, r14.w  // fF<0:Inf>

#line 31
    div r13.z, r13.w, l(2.000000)  // fK<0:Inf:[0f,1.#INFf]>
    nop 
    mov r15.w, r15.w  // fDotNV<0:[0f,1f]>
    mov r13.z, r13.z  // fK<0:Inf:[0f,1.#INFf]>
...
#line 3
    ...
    div r14.w, l(1.000000), r14.w  // G1V<0:NaN:Inf>
...
#line 3
    ...
    div r13.z, l(1.000000), r13.z  // G1V<0:NaN:Inf>

#line 32
    mul r13.z, r13.z, r14.w  // fVis<0:NaN:Inf>
    mul r13.y, r13.y, r15.w
    mul r13.x, r13.x, r13.y
    mul r13.x, r13.z, r13.x  // fSpecular<0:NaN:Inf>
    mov r13.x, r13.x  // fLightingFuncGGX<0:NaN:Inf>

#line 210 "lightingconstants.h"
    mov r13.x, r13.x  // fSpecMul<0:NaN:Inf>
    mul r13.xyz, r13.xxxx, r18.xyzx
    mul r13.xyz, r11.wwww, r13.xyzx  // f3LightColorSpecularResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 216
    ine r11.w, l(0, 0, 0, 0), cb5[6].z
    if_nz r11.w
...
#line 138
    ...
    mov r13.z, -r13.z  // f3uv<2:NaN:Inf>
    nop 
    mov r13.xy, r13.xyxx  // f3Vec<0:NaN:Inf,1:NaN:Inf>
    mov r13.z, r13.z  // f3Vec<2:NaN:Inf>

#line 21
    mov r13.x, r13.x  // fx<0:NaN:Inf>
    mov r13.y, r13.y  // fy<0:NaN:Inf>
    mov r13.z, r13.z  // fz<0:NaN:Inf>
    mov r13.w, -r13.x
    max r13.w, r13.w, r13.x
    mov r14.w, -r13.y
    max r14.w, r13.y, r14.w
    lt r15.w, r14.w, r13.w
    mov r16.w, -r13.z
    max r16.w, r13.z, r16.w
    lt r17.x, r16.w, r13.w
...
#line 141
    mov r13.y, r13.x  // iFace<0:[0,5]>
    imul null, r13.x, r13.x, l(4)
    imad r9.w, r9.w, l(24), r13.x
    mov r0.w, l(1.000000)
    dp4 r17.x, r0.xyzw, cb3[r9.w + 0].xyzw  // f4ShadowTexCoord<0:NaN:Inf>
    dp4 r17.y, r0.xyzw, cb3[r9.w + 1].xyzw  // f4ShadowTexCoord<1:NaN:Inf>
    dp4 r17.z, r0.xyzw, cb3[r9.w + 2].xyzw  // f4ShadowTexCoord<2:NaN:Inf>
    dp4 r0.w, r0.xyzw, cb3[r9.w + 3].xyzw  // f4ShadowTexCoord<3:NaN:Inf>
    div r13.xzw, r17.xxyz, r0.wwww  // f4ShadowTexCoord<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    div r0.w, r13.x, l(2.000000)
    add r0.w, r0.w, l(0.500000)  // f4ShadowTexCoord<0:NaN:Inf>
    div r9.w, r13.z, l(-2.000000)
    add r9.w, r9.w, l(0.500000)  // f4ShadowTexCoord<1:NaN:Inf>
    itof r13.x, r13.y
    add r0.w, r0.w, r13.x  // f4ShadowTexCoord<0:NaN:Inf>
...
#line 152
    ...
    mov r0.w, -r0.w
    add r0.w, r0.w, r13.w  // f4ShadowTexCoord<2:NaN:Inf>
    nop 
...
#line 84
    sample_c_lz_indexable(-3,-3,0)(texture2d)(float,float,float,float) r9.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, l(0.000000)  // fShadow<0:[0f,1f]>
    sample_c_lz_indexable(-3,-2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,2f]>
    sample_c_lz_indexable(-3,-1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,3f]>
    sample_c_lz_indexable(-3,0,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,4f]>
    sample_c_lz_indexable(-3,1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,5f]>
    sample_c_lz_indexable(-3,2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,6f]>
    sample_c_lz_indexable(-3,3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,7f]>
    sample_c_lz_indexable(-2,-3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,8f]>
    sample_c_lz_indexable(-2,-2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,9f]>
    sample_c_lz_indexable(-2,-1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,10f]>
    sample_c_lz_indexable(-2,0,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,11f]>
    sample_c_lz_indexable(-2,1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,12f]>
    sample_c_lz_indexable(-2,2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,13f]>
    sample_c_lz_indexable(-2,3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,14f]>
    sample_c_lz_indexable(-1,-3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,15f]>
    sample_c_lz_indexable(-1,-2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,16f]>
    sample_c_lz_indexable(-1,-1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,17f]>
    sample_c_lz_indexable(-1,0,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,18f]>
    sample_c_lz_indexable(-1,1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,19f]>
    sample_c_lz_indexable(-1,2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,20f]>
    sample_c_lz_indexable(-1,3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,21f]>
    sample_c_lz_indexable(0,-3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,22f]>
    sample_c_lz_indexable(0,-2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,23f]>
    sample_c_lz_indexable(0,-1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,24f]>
    sample_c_lz_indexable(0,0,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,25f]>
    sample_c_lz_indexable(0,1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,26f]>
    sample_c_lz_indexable(0,2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,27f]>
    sample_c_lz_indexable(0,3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,28f]>
    sample_c_lz_indexable(1,-3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,29f]>
    sample_c_lz_indexable(1,-2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,30f]>
    sample_c_lz_indexable(1,-1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,31f]>
    sample_c_lz_indexable(1,0,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,32f]>
    sample_c_lz_indexable(1,1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,33f]>
    sample_c_lz_indexable(1,2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,34f]>
    sample_c_lz_indexable(1,3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,35f]>
    sample_c_lz_indexable(2,-3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,36f]>
    sample_c_lz_indexable(2,-2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,37f]>
    sample_c_lz_indexable(2,-1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,38f]>
    sample_c_lz_indexable(2,0,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,39f]>
    sample_c_lz_indexable(2,1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,40f]>
    sample_c_lz_indexable(2,2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,41f]>
    sample_c_lz_indexable(2,3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,42f]>
    sample_c_lz_indexable(3,-3,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,43f]>
    sample_c_lz_indexable(3,-2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,44f]>
    sample_c_lz_indexable(3,-1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,45f]>
    sample_c_lz_indexable(3,0,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,46f]>
    sample_c_lz_indexable(3,1,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,47f]>
    sample_c_lz_indexable(3,2,0)(texture2d)(float,float,float,float) r11.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r9.w, r9.w, r11.w  // fShadow<0:[0f,48f]>
    sample_c_lz_indexable(3,3,0)(texture2d)(float,float,float,float) r0.w, r13.xyxx, t13.xxxx, s1, r0.w
    add r0.w, r0.w, r9.w  // fShadow<0:[0f,49f]>
...
#line 417
  ...
  if_nz r0.w
    ld_indexable(buffer)(float,float,float,float) r17.xyz, r10.wwww, t2.xyzw  // f4CenterAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>
    ld_indexable(buffer)(float,float,float,float) r18.xyz, r10.wwww, t3.xyzw  // f3LightCol<0:Inf,1:Inf,2:Inf>
...
#line 424
    ...
    mov r19.xy, cb5[3].xzxx  // f4SSSBRDFParams<0,2>
    mov r20.xyz, cb5[2].xyzx  // f4ColorSSS<0,1,2>
    mov r21.xyzw, v6.xyzw  // f4VertexPos<0,1,2,3>
    mov r22.xyz, v5.xyzx  // f3CamPos<0,1,2>
    mov r15.xyz, r15.xyzx  // f3LightColorSpecularResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r13.xyz, r13.xyzx  // f3LightDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 155 "constant.h"
    mov r19.x, r19.x  // fMaterialThickness<0>
    mov r19.y, r19.y  // fRimScalar<0>
    mov r20.x, r20.x  // fExtinctionCoefficientRed<0>
    mov r20.y, r20.y  // fExtinctionCoefficientGreen<0>
    mov r20.z, r20.z  // fExtinctionCoefficientBlue<0>
...
#line 168
    ...
    rsq r9.w, r9.w
    mul r22.xyz, r9.wwww, r22.xyzx  // f3EyeVector<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r23.xyz, -r22.xyzx  // f3LightDirSSS<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r17.xyz, r17.xyzx  // f4LightPos<0:Inf,1:Inf,2:Inf>
    mov r17.w, l(1.000000)  // f4LightPos<3: 1f>
    mov r21.xyzw, -r21.xyzw
    add r17.xyzw, r17.xyzw, r21.xyzw
    dp4 r9.w, r17.xyzw, r17.xyzw
    sqrt r9.w, r9.w
...
#line 176
    nop 
    mov r23.xyz, r23.xyzx  // f3Vec1<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r17.xyz, r14.xyzx  // f3Vec2<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 138
    dp3 r10.w, r23.xyzx, r17.xyzx  // fProduct<0:NaN:Inf>
...
#line 176
    mul r21.xyz, r9.wwww, r10.wwww  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r24.xyz, -r14.xyzx
    dp3 r10.w, r24.xyzx, r23.xyzx
    max r10.w, r10.w, l(0.000000)
    mul r24.xyz, r10.wwww, r19.xxxx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 

#line 138
    dp3 r10.w, r23.xyzx, r23.xyzx  // fProduct<0:NaN:Inf>
    mul r10.w, r10.w, l(0.500000)  // fProduct<0:NaN:Inf>
    add r10.w, r10.w, l(0.500000)  // fProduct<0:NaN:Inf>
    mov r10.w, r10.w  // HalfLambert<0:NaN:Inf>
...
#line 179
    ...
    add r24.xyz, r10.wwww, r24.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r24.xyz, r9.wwww, r24.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r25.x, r20.x, r24.x  // f3IndirectLightComponent<0:NaN:Inf>
    mul r25.y, r20.y, r24.y  // f3IndirectLightComponent<1:NaN:Inf>
    mul r25.z, r20.z, r24.z  // f3IndirectLightComponent<2:NaN:Inf>
    mul r20.xyz, r0.wwww, r25.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r0.w, r14.xyzx, r22.xyzx
    max r0.w, r0.w, l(0.000000)
    mov r10.w, -r0.w
    add r22.xyz, r10.wwww, l(1.000000, 1.000000, 1.000000, 0.000000)  // f3Rim<0:Inf:[-1.#INFf,1f],1:Inf:[-1.#INFf,1f],2:Inf:[-1.#INFf,1f]>
    mul r22.xyz, r22.xyzx, r22.xyzx  // f3Rim<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r10.w, r14.xyzx, r23.xyzx
    max r10.w, r10.w, l(0.000000)
    mul r14.xyz, r15.xyzx, r10.wwww
    mul r14.xyz, r14.xyzx, r22.xyzx  // f3Rim<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 190
    mul r16.xyz, r16.xyzx, r21.xyzx  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    add r16.xyz, r20.xyzx, r16.xyzx  // f4FinColor<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r14.xyz, r19.yyyy, r14.xyzx
...
#line 146
    add r16.xyz, r23.xyzx, r17.xyzx
    dp3 r10.w, r16.xyzx, r16.xyzx
    rsq r10.w, r10.w
    mul r16.xyz, r10.wwww, r16.xyzx  // f3HalfAngle<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r10.w, r17.xyzx, r16.xyzx
    max r10.w, r10.w, l(0.000000)
...
#line 200
    ...
    lt r9.w, l(2.000000), r19.x
    and r0.w, r0.w, r9.w
    if_nz r0.w
      div r16.xyz, r20.xyzx, l(15.000000, 15.000000, 15.000000, 0.000000)
...
#line 272
  ...
  mul r3.w, r19.y, r19.y
  mov r3.w, -r3.w
  add r1.w, r1.w, r3.w
  sqrt r1.w, r1.w  // f3SpotLightDir<2:NaN>

#line 276
  lt r3.w, l(0.000000), r18.w
  mov r5.w, -r1.w
  movc r19.z, r3.w, r1.w, r5.w  // f3SpotLightDir<2:NaN>
  ...
  rsq r5.w, r1.w
  mul r17.xyz, r5.wwww, r13.xyzx  // f3ToLightNormalized<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  sqrt r1.w, r1.w  // fLightDistance<0:NaN:Inf>
  mov r20.xyz, -r17.xyzx
  dp3 r5.w, r20.xyzx, r19.xyzx  // fCosineOfCurrentAngle<0:NaN:Inf>

#line 288
  mov r18.x, r18.x  // fRad<0:Inf>
  mov r6.w, -r18.w
  movc r3.w, r3.w, r18.w, r6.w  // fCosineOfConeAngle<0:Inf>
  lt r6.w, r1.w, r18.x
  lt r8.w, r3.w, r5.w
  and r6.w, r6.w, r8.w
  if_nz r6.w
    ...
    div r3.w, r3.w, r5.w  // fRadialAttenuation<0:NaN:Inf>
    mul r3.w, r3.w, r3.w
    max r3.w, r3.w, l(0.000000)
    min r3.w, r3.w, l(1.000000)  // fRadialAttenuation<0:[0f,1f]>
    div r5.w, r1.w, r18.x  // fx<0:NaN:Inf>
...
#line 303
    ...
    mul r1.w, r1.w, r1.w
    add r1.w, r1.w, l(1.000000)
    div r1.w, r5.w, r1.w  // fFallOff<0:NaN:Inf>
    ld_indexable(buffer)(float,float,float,float) r18.xyz, r1.zzzz, t6.xyzw
    dp3 r5.w, r17.xyzx, r14.xyzx
    max r5.w, r5.w, l(0.000000)
    min r5.w, r5.w, l(1.000000)
    mul r17.xyz, r5.wwww, r18.xyzx
    mul r17.xyz, r1.wwww, r17.xyzx
    mul r17.xyz, r3.wwww, r17.xyzx  // f3LightColorDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 8 "ggxlighting.h"
    ...
    rsq r8.w, r8.w
    mul r19.xyz, r8.wwww, r19.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r5.w, r5.w, r5.w  // fAlpha<0:Inf:[0f,1.#INFf]>
    add r20.xyz, r13.xyzx, r15.xyzx
    dp3 r8.w, r20.xyzx, r20.xyzx
    rsq r8.w, r8.w
    mul r20.xyz, r8.wwww, r20.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r8.w, r19.xyzx, r13.xyzx
    max r8.w, r8.w, l(0.000000)
    min r8.w, r8.w, l(1.000000)  // fDotNL<0:[0f,1f]>
    dp3 r9.w, r19.xyzx, r15.xyzx
    max r9.w, r9.w, l(0.000000)
    min r9.w, r9.w, l(1.000000)  // fDotNV<0:[0f,1f]>
    dp3 r10.w, r19.xyzx, r20.xyzx
    max r10.w, r10.w, l(0.000000)
    min r10.w, r10.w, l(1.000000)  // fDotNH<0:[0f,1f]>
    dp3 r11.w, r13.xyzx, r20.xyzx
    max r11.w, r11.w, l(0.000000)
    min r11.w, r11.w, l(1.000000)  // fDotLH<0:[0f,1f]>

#line 21
    mul r12.w, r5.w, r5.w  // fAlphaSqr<0:NaN:Inf>
    mul r10.w, r10.w, r10.w
    add r13.x, r12.w, l(-1.000000)
    mul r10.w, r10.w, r13.x
    add r10.w, r10.w, l(1.000000)  // fDenom<0:NaN:Inf>
    mul r13.x, r10.w, l(3.141590)
    mul r10.w, r10.w, r13.x
    div r10.w, r12.w, r10.w  // fD<0:NaN:Inf>

#line 27
    mov r11.w, -r11.w
    add r11.w, r11.w, l(1.000000)
    mul r12.w, r11.w, l(1.000000)
    mul r11.w, r11.w, r11.w
    mul r11.w, r11.w, r11.w
    mul r11.w, r11.w, r12.w  // fDotLH5<0:[0f,1f]>
    mov r12.w, -r6.w
    add r12.w, r12.w, l(1.000000)
    mul r11.w, r11.w, r12.w
    add r6.w, r6.w, r11.w  // fF<0:Inf>

#line 31
    div r5.w, r5.w, l(2.000000)  // fK<0:Inf:[0f,1.#INFf]>
    nop 
    mov r8.w, r8.w  // fDotNV<0:[0f,1f]>
    mov r5.w, r5.w  // fK<0:Inf:[0f,1.#INFf]>

#line 3
    mov r11.w, -r5.w
    add r11.w, r11.w, l(1.000000)
    mul r12.w, r8.w, r11.w
    add r12.w, r5.w, r12.w
...
#line 3
    mul r9.w, r11.w, r9.w
    add r5.w, r5.w, r9.w
    div r5.w, l(1.000000), r5.w  // G1V<0:NaN:Inf>

#line 32
    mul r5.w, r5.w, r12.w  // fVis<0:NaN:Inf>
    mul r8.w, r10.w, r8.w
    mul r6.w, r6.w, r8.w
    mul r5.w, r5.w, r6.w  // fSpecular<0:NaN:Inf>
    mov r5.w, r5.w  // fLightingFuncGGX<0:NaN:Inf>

#line 310 "lightingconstants.h"
    mov r5.w, r5.w  // fSpecMul<0:NaN:Inf>
    mul r13.xyz, r5.wwww, r18.xyzx
    mul r13.xyz, r1.wwww, r13.xyzx
    mul r13.xyz, r3.wwww, r13.xyzx  // f3LightColorSpecularResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 162
    ...
    div r0.w, r13.x, l(2.000000)
    add r0.w, r0.w, l(0.500000)  // f4ShadowTexCoord<0:NaN:Inf>
    div r3.w, r13.y, l(-2.000000)
    add r13.y, r3.w, l(0.500000)  // f4ShadowTexCoord<1:NaN:Inf>
    utof r1.w, r1.w
...
#line 84
    ...
    sample_c_lz_indexable(-3,-2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,2f]>
    sample_c_lz_indexable(-3,-1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,3f]>
    sample_c_lz_indexable(-3,0,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,4f]>
    sample_c_lz_indexable(-3,1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,5f]>
    sample_c_lz_indexable(-3,2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,6f]>
    sample_c_lz_indexable(-3,3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,7f]>
    sample_c_lz_indexable(-2,-3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,8f]>
    sample_c_lz_indexable(-2,-2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,9f]>
    sample_c_lz_indexable(-2,-1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,10f]>
    sample_c_lz_indexable(-2,0,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,11f]>
    sample_c_lz_indexable(-2,1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,12f]>
    sample_c_lz_indexable(-2,2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,13f]>
    sample_c_lz_indexable(-2,3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,14f]>
    sample_c_lz_indexable(-1,-3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,15f]>
    sample_c_lz_indexable(-1,-2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,16f]>
    sample_c_lz_indexable(-1,-1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,17f]>
    sample_c_lz_indexable(-1,0,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,18f]>
    sample_c_lz_indexable(-1,1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,19f]>
    sample_c_lz_indexable(-1,2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,20f]>
    sample_c_lz_indexable(-1,3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,21f]>
    sample_c_lz_indexable(0,-3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,22f]>
    sample_c_lz_indexable(0,-2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,23f]>
    sample_c_lz_indexable(0,-1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,24f]>
    sample_c_lz_indexable(0,0,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,25f]>
    sample_c_lz_indexable(0,1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,26f]>
    sample_c_lz_indexable(0,2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,27f]>
    sample_c_lz_indexable(0,3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,28f]>
    sample_c_lz_indexable(1,-3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,29f]>
    sample_c_lz_indexable(1,-2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,30f]>
    sample_c_lz_indexable(1,-1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,31f]>
    sample_c_lz_indexable(1,0,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,32f]>
    sample_c_lz_indexable(1,1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,33f]>
    sample_c_lz_indexable(1,2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,34f]>
    sample_c_lz_indexable(1,3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,35f]>
    sample_c_lz_indexable(2,-3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,36f]>
    sample_c_lz_indexable(2,-2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,37f]>
    sample_c_lz_indexable(2,-1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,38f]>
    sample_c_lz_indexable(2,0,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,39f]>
    sample_c_lz_indexable(2,1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,40f]>
    sample_c_lz_indexable(2,2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,41f]>
    sample_c_lz_indexable(2,3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,42f]>
    sample_c_lz_indexable(3,-3,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,43f]>
    sample_c_lz_indexable(3,-2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,44f]>
    sample_c_lz_indexable(3,-1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,45f]>
    sample_c_lz_indexable(3,0,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,46f]>
    sample_c_lz_indexable(3,1,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,47f]>
    sample_c_lz_indexable(3,2,0)(texture2d)(float,float,float,float) r3.w, r13.xyxx, t14.xxxx, s1, r0.w
    add r1.w, r1.w, r3.w  // fShadow<0:[0f,48f]>
...
#line 168
    ...
    rsq r3.w, r3.w
    mul r21.xyz, r3.wwww, r21.xyzx  // f3EyeVector<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 138
    dp3 r5.w, r22.xyzx, r16.xyzx  // fProduct<0:NaN:Inf>
...
#line 176
    mul r20.xyz, r3.wwww, r5.wwww  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r23.xyz, -r14.xyzx
    dp3 r5.w, r23.xyzx, r22.xyzx
    max r5.w, r5.w, l(0.000000)
    mul r23.xyz, r1.zzzz, r5.wwww  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 

#line 138
    dp3 r5.w, r22.xyzx, r22.xyzx  // fProduct<0:NaN:Inf>
    mul r5.w, r5.w, l(0.500000)  // fProduct<0:NaN:Inf>
    add r5.w, r5.w, l(0.500000)  // fProduct<0:NaN:Inf>
    mov r5.w, r5.w  // HalfLambert<0:NaN:Inf>
...
#line 179
    mul r5.w, r1.z, r5.w
    add r23.xyz, r5.wwww, r23.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r23.xyz, r3.wwww, r23.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    max r0.w, r0.w, l(0.000000)
    mov r5.w, -r0.w
    add r21.xyz, r5.wwww, l(1.000000, 1.000000, 1.000000, 0.000000)  // f3Rim<0:Inf:[-1.#INFf,1f],1:Inf:[-1.#INFf,1f],2:Inf:[-1.#INFf,1f]>
    mul r21.xyz, r21.xyzx, r21.xyzx  // f3Rim<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r5.w, r14.xyzx, r22.xyzx
    max r5.w, r5.w, l(0.000000)
    mul r14.xyz, r15.xyzx, r5.wwww
...
nop 
lt r0.z, r7.w, r0.z
imad r0.w, r0.y, r2.w, l(4)
iadd r0.x, r0.w, r0.x
movc r0.x, r0.z, r0.w, r0.x  // uFirstLightIndex<0>
imad r0.w, r0.y, r2.w, l(2)
ld_indexable(buffer)(uint,uint,uint,uint) r0.w, r0.wwww, t11.yzwx
imad r0.y, r0.y, r2.w, l(3)
...
#line 489
mov r0.x, r0.x  // i<0>
mov r5.xyz, r3.xyzx  // f3AccumDiffuse<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
mov r0.z, r0.x  // i<0>
loop 
  iadd r0.w, r0.x, r0.y
  ult r0.w, r0.z, r0.w
...
#line 495
  nop 
  mov r0.w, r0.w  // uLightIndex<0>
  mov r6.xyz, r2.xyzx  // f3Position<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  mov r11.xyz, r7.xyzx  // f3Norm<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 340 "lightingconstants.h"
  ...
  mov r6.xyz, -r6.xyzx
  add r6.xyz, r6.xyzx, r12.xyzx  // f3ToLight<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  dp3 r1.w, r6.xyzx, r6.xyzx
  rsq r2.w, r1.w
  mul r6.xyz, r2.wwww, r6.xyzx  // f3LightDir<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  sqrt r1.w, r1.w  // fLightDistance<0:NaN:Inf>
...
#line 349
  ...
  max r2.w, r2.w, l(0.000000)  // fVPLNormalDotDir<0:Inf:[-0f,1.#INFf]>
  lt r3.w, r1.w, r1.z
  lt r5.w, l(0.000000), r2.w
  and r3.w, r3.w, r5.w
  if_nz r3.w
    mov r14.xyz, r14.xyzx  // f3LightColor<0,1,2>
    div r1.z, r1.w, r1.z  // fx<0:NaN:Inf>
    add r1.z, r1.z, l(-1.000000)
    ...
    mul r1.z, r1.z, r1.z
    mul r1.z, r1.z, r1.w  // fFallOff<0:[0f,3f]>
    dp3 r1.w, r15.xyzx, r11.xyzx  // fSourceLightDotL<0:NaN:Inf>

#line 360
    lt r3.w, r1.w, l(0.000000)
    if_nz r3.w
      div r1.w, r1.w, cb2[26].w
      add r1.w, r1.w, l(1.000000)  // fSourceLightDotL<0:NaN:Inf>
    else 

#line 366
      mov r1.w, l(1.000000)  // fSourceLightDotL<0: 1f>
...
#line 369
    ...
    mul r6.xyz, r1.wwww, r6.xyzx  // f3LightColorDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 500
  ...
  if_nz r1.z
    ...
    mov r14.xyz, r4.yzwy  // f4TexColor<0:Inf,1:Inf,2:Inf>
    dp3 r0.w, r10.xyzx, r10.xyzx
    sqrt r0.w, r0.w  // fThickValue<0:NaN:Inf>
    nop 
    mov r12.xyz, r12.xyzx  // f4CenterAndRadius<0,1,2>
    mov r13.xyz, r13.xyzx  // f3LightColor<0,1,2>
    mov r14.xyz, r14.xyzx  // float4TexColor<0:Inf,1:Inf,2:Inf>
    mov r0.w, r0.w  // fThickValue<0:NaN:Inf>
    ...
    mov r6.xyz, r6.xyzx  // f3LightDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 168
    ...
    rsq r1.w, r1.w
    mul r17.xyz, r1.wwww, r17.xyzx  // f3EyeVector<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    dp4 r1.w, r12.xyzw, r12.xyzw
    sqrt r1.w, r1.w
    div r1.w, l(1.000000), r1.w
    mul r1.w, r1.w, l(10.000000)  // fAttenuation<0:NaN:Inf>

#line 176
    nop 
    mov r18.xyz, r18.xyzx  // f3Vec1<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r12.xyz, r11.xyzx  // f3Vec2<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 138
    dp3 r2.w, r18.xyzx, r12.xyzx  // fProduct<0:NaN:Inf>
    mul r2.w, r2.w, l(0.500000)  // fProduct<0:NaN:Inf>
    add r2.w, r2.w, l(0.500000)  // fProduct<0:NaN:Inf>
    mov r2.w, r2.w  // HalfLambert<0:NaN:Inf>

#line 176
    mul r12.xyz, r1.wwww, r2.wwww  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r16.xyz, -r11.xyzx
    dp3 r2.w, r16.xyzx, r18.xyzx
    max r2.w, r2.w, l(0.000000)
    mul r16.xyz, r1.zzzz, r2.wwww  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 

#line 138
    dp3 r2.w, r18.xyzx, r18.xyzx  // fProduct<0:NaN:Inf>
    mul r2.w, r2.w, l(0.500000)  // fProduct<0:NaN:Inf>
    add r2.w, r2.w, l(0.500000)  // fProduct<0:NaN:Inf>
    mov r2.w, r2.w  // HalfLambert<0:NaN:Inf>
...
#line 179
    mul r2.w, r1.z, r2.w
    add r16.xyz, r2.wwww, r16.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r16.xyz, r1.wwww, r16.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 202
      div r11.xyz, r15.xyzx, l(15.000000, 15.000000, 15.000000, 0.000000)
      mul r6.xyz, r6.xyzx, r11.xyzx  // f3LightDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    else 

#line 207
      mul r6.xyz, r6.xyzx, r12.xyzx  // f3LightDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 515
  add r5.xyz, r5.xyzx, r6.xyzx  // f3AccumDiffuse<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 520
mul r0.xyz, r5.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // f3AccumDiffuse<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
ret 
// Approximately 1677 instruction slots used
