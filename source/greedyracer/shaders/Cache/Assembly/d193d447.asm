...
ld_indexable(buffer)(uint,uint,uint,uint) r1.w, r1.zzzz, t4.yzwx
movc r1.w, r4.w, r8.z, r1.w  // uNumLights<0>
...
loop 
  ...
  ult r8.z, r4.w, r8.z
  breakc_z r8.z
  ld_indexable(buffer)(uint,uint,uint,uint) r8.z, r4.wwww, t4.yzxw
  mov r8.z, r8.z  // uLightIndex<0>
...
#line 186 "lightingconstants.h"
  ld_indexable(buffer)(float,float,float,float) r16.xyzw, r8.zzzz, t2.wxyz  // f4CenterAndRadius<3:Inf,0:Inf,1:Inf,2:Inf>
  mov r12.xyz, -r12.xyzx
  add r12.xyz, r12.xyzx, r16.yzwy  // f3ToLight<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  dp3 r8.w, r12.xyzx, r12.xyzx
  rsq r9.w, r8.w
  mul r16.yzw, r9.wwww, r12.xxyz  // f3LightDir<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 204
    ...
    div r8.w, r9.w, r8.w  // fFallOff<0:NaN:Inf>
    ld_indexable(buffer)(float,float,float,float) r17.xyz, r8.zzzz, t3.xyzw
    dp3 r9.w, r16.yzwy, r13.xyzx
    max r9.w, r9.w, l(0.000000)
    min r9.w, r9.w, l(1.000000)
    mul r16.xyz, r9.wwww, r17.xyzx
    mul r16.xyz, r8.wwww, r16.xyzx  // f3LightColorDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 8 "ggxlighting.h"
    ...
    rsq r11.w, r11.w
    mul r18.xyz, r11.wwww, r18.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r9.w, r9.w, r9.w  // fAlpha<0:Inf:[0f,1.#INFf]>
    add r19.xyz, r12.xyzx, r14.xyzx
    dp3 r11.w, r19.xyzx, r19.xyzx
    rsq r11.w, r11.w
    mul r19.xyz, r11.wwww, r19.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r11.w, r18.xyzx, r12.xyzx
    max r11.w, r11.w, l(0.000000)
    min r11.w, r11.w, l(1.000000)  // fDotNL<0:[0f,1f]>
    dp3 r12.w, r18.xyzx, r14.xyzx
    max r12.w, r12.w, l(0.000000)
    min r12.w, r12.w, l(1.000000)  // fDotNV<0:[0f,1f]>
    dp3 r13.w, r18.xyzx, r19.xyzx
    max r13.w, r13.w, l(0.000000)
    min r13.w, r13.w, l(1.000000)  // fDotNH<0:[0f,1f]>
    dp3 r12.x, r12.xyzx, r19.xyzx
    max r12.x, r12.x, l(0.000000)
    min r12.x, r12.x, l(1.000000)  // fDotLH<0:[0f,1f]>

#line 21
    mul r12.y, r9.w, r9.w  // fAlphaSqr<0:NaN:Inf>
    mul r12.z, r13.w, r13.w
    add r13.w, r12.y, l(-1.000000)
    mul r12.z, r12.z, r13.w
    add r12.z, r12.z, l(1.000000)  // fDenom<0:NaN:Inf>
    mul r13.w, r12.z, l(3.141590)
    mul r12.z, r12.z, r13.w
...
#line 27
    ...
    add r10.w, r10.w, r12.x  // fF<0:Inf>

#line 31
    div r9.w, r9.w, l(2.000000)  // fK<0:Inf:[0f,1.#INFf]>
    nop 
    mov r11.w, r11.w  // fDotNV<0:[0f,1f]>
    mov r9.w, r9.w  // fK<0:Inf:[0f,1.#INFf]>

#line 3
    mov r12.x, -r9.w
    add r12.x, r12.x, l(1.000000)
    mul r12.z, r11.w, r12.x
    add r12.z, r9.w, r12.z
...
#line 3
    mul r12.x, r12.x, r12.w
    add r9.w, r9.w, r12.x
    div r9.w, l(1.000000), r9.w  // G1V<0:NaN:Inf>

#line 32
    mul r9.w, r9.w, r12.z  // fVis<0:NaN:Inf>
    mul r11.w, r12.y, r11.w
    mul r10.w, r10.w, r11.w
    mul r9.w, r9.w, r10.w  // fSpecular<0:NaN:Inf>
    mov r9.w, r9.w  // fLightingFuncGGX<0:NaN:Inf>

#line 210 "lightingconstants.h"
    mov r9.w, r9.w  // fSpecMul<0:NaN:Inf>
    mul r12.xyz, r9.wwww, r17.xyzx
    mul r12.xyz, r8.wwww, r12.xyzx  // f3LightColorSpecularResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 216
    ine r8.w, l(0, 0, 0, 0), cb5[6].z
    if_nz r8.w
...
#line 417
  ...
  if_nz r8.w
    ld_indexable(buffer)(float,float,float,float) r16.xyz, r8.zzzz, t2.xyzw  // f4CenterAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>
    ld_indexable(buffer)(float,float,float,float) r17.xyz, r8.zzzz, t3.xyzw  // f3LightCol<0:Inf,1:Inf,2:Inf>

#line 424
    dp3 r8.z, r9.xyzx, r9.xyzx
    sqrt r8.z, r8.z  // fThickValue<0:NaN:Inf>
    nop 
    ...
    mov r8.z, r8.z  // fThickValue<0:NaN:Inf>
...
#line 168
    ...
    rsq r8.w, r8.w
    mul r21.xyz, r8.wwww, r21.xyzx  // f3EyeVector<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    dp4 r8.w, r16.xyzw, r16.xyzw
    sqrt r8.w, r8.w
    div r8.w, l(1.000000), r8.w
    mul r8.w, r8.w, l(10.000000)  // fAttenuation<0:NaN:Inf>
...
#line 138
    dp3 r9.w, r22.xyzx, r16.xyzx  // fProduct<0:NaN:Inf>
...
#line 176
    mul r20.xyz, r8.wwww, r9.wwww  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r23.xyz, -r13.xyzx
    dp3 r9.w, r23.xyzx, r22.xyzx
    max r9.w, r9.w, l(0.000000)
    mul r23.xyz, r9.wwww, r18.xxxx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 

#line 138
    dp3 r9.w, r22.xyzx, r22.xyzx  // fProduct<0:NaN:Inf>
    mul r9.w, r9.w, l(0.500000)  // fProduct<0:NaN:Inf>
    add r9.w, r9.w, l(0.500000)  // fProduct<0:NaN:Inf>
    mov r9.w, r9.w  // HalfLambert<0:NaN:Inf>
...
#line 179
    mul r9.w, r18.x, r9.w
    add r23.xyz, r9.wwww, r23.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r23.xyz, r8.wwww, r23.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    mul r19.xyz, r8.zzzz, r24.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r8.z, r13.xyzx, r21.xyzx
    max r8.z, r8.z, l(0.000000)
    mov r9.w, -r8.z
    add r21.xyz, r9.wwww, l(1.000000, 1.000000, 1.000000, 0.000000)  // f3Rim<0:Inf:[-1.#INFf,1f],1:Inf:[-1.#INFf,1f],2:Inf:[-1.#INFf,1f]>
    mul r21.xyz, r21.xyzx, r21.xyzx  // f3Rim<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r9.w, r13.xyzx, r22.xyzx
    max r9.w, r9.w, l(0.000000)
    mul r13.xyz, r14.xyzx, r9.wwww
...
#line 146
    ...
    rsq r9.w, r9.w
    mul r15.xyz, r9.wwww, r15.xyzx  // f3HalfAngle<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r9.w, r16.xyzx, r15.xyzx
    max r9.w, r9.w, l(0.000000)
    min r9.w, r9.w, l(1.000000)
...
#line 200
    lt r8.z, r8.z, l(0.800000)
    lt r8.w, l(2.000000), r18.x
    and r8.z, r8.w, r8.z
    if_nz r8.z
...
#line 123
ld_indexable(buffer)(uint,uint,uint,uint) r1.w, r2.wwww, t8.yzwx
mov r1.w, r1.w  // uHalfZBitsHigh<0>
ld_indexable(buffer)(uint,uint,uint,uint) r2.x, r5.wwww, t8.xyzw
mov r2.x, r2.x  // uHalfZBitsLow<0>
ishl r1.w, r1.w, l(16)
or r1.w, r2.x, r1.w  // uHalfZBits<0>
mov r1.w, r1.w  // fHalfZ<0:NaN:Inf>
nop 
lt r1.w, r6.w, r1.w
movc r0.w, r1.w, r7.w, r0.w  // uFirstLightIndex<0>
ld_indexable(buffer)(uint,uint,uint,uint) r2.x, r8.yyyy, t8.xyzw
ld_indexable(buffer)(uint,uint,uint,uint) r1.z, r1.zzzz, t8.yzxw
movc r1.z, r1.w, r2.x, r1.z  // uNumLights<0>
...
loop 
  ...
  ult r2.w, r1.w, r2.w
  breakc_z r2.w
  ld_indexable(buffer)(uint,uint,uint,uint) r2.w, r1.wwww, t8.yzwx
...
#line 267 "lightingconstants.h"
  ld_indexable(buffer)(float,float,float,float) r16.xyzw, r2.wwww, t5.xyzw  // f4BoundingSphereCenterAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>
  ld_indexable(buffer)(float,float,float,float) r17.xyzw, r2.wwww, t7.wxyz  // f4SpotParams<3:Inf,0:Inf,1:Inf,2:Inf>
...
#line 272
  ...
  mul r5.w, r18.y, r18.y
  mov r5.w, -r5.w
  add r4.w, r4.w, r5.w
  sqrt r4.w, r4.w  // f3SpotLightDir<2:NaN>

#line 276
  lt r5.w, l(0.000000), r17.w
  mov r6.w, -r4.w
  movc r18.z, r5.w, r4.w, r6.w  // f3SpotLightDir<2:NaN>
  ...
  rsq r6.w, r4.w
  mul r16.xyz, r6.wwww, r12.xyzx  // f3ToLightNormalized<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  sqrt r4.w, r4.w  // fLightDistance<0:NaN:Inf>
  mov r19.xyz, -r16.xyzx
  dp3 r6.w, r19.xyzx, r18.xyzx  // fCosineOfCurrentAngle<0:NaN:Inf>

#line 288
  mov r17.x, r17.x  // fRad<0:Inf>
  mov r7.w, -r17.w
  movc r5.w, r5.w, r17.w, r7.w  // fCosineOfConeAngle<0:Inf>
  lt r7.w, r4.w, r17.x
  lt r8.w, r5.w, r6.w
  and r7.w, r7.w, r8.w
  if_nz r7.w
    ...
    div r6.w, r4.w, r17.x  // fx<0:NaN:Inf>
...
#line 303
    ...
    ld_indexable(buffer)(float,float,float,float) r17.xyz, r2.wwww, t6.xyzw
    dp3 r6.w, r16.xyzx, r13.xyzx
    max r6.w, r6.w, l(0.000000)
    min r6.w, r6.w, l(1.000000)
    mul r16.xyz, r6.wwww, r17.xyzx
    mul r16.xyz, r4.wwww, r16.xyzx
    mul r16.xyz, r5.wwww, r16.xyzx  // f3LightColorDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r16.xyz, r16.xyzx, cb5[1].yyyy  // f3LightColorDiffuseResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 8 "ggxlighting.h"
    ...
    rsq r8.w, r8.w
    mul r18.xyz, r8.wwww, r18.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r6.w, r6.w, r6.w  // fAlpha<0:Inf:[0f,1.#INFf]>
    add r19.xyz, r12.xyzx, r14.xyzx
    dp3 r8.w, r19.xyzx, r19.xyzx
    rsq r8.w, r8.w
    mul r19.xyz, r8.wwww, r19.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    dp3 r11.w, r12.xyzx, r19.xyzx
    max r11.w, r11.w, l(0.000000)
    min r11.w, r11.w, l(1.000000)  // fDotLH<0:[0f,1f]>

#line 21
    mul r12.x, r6.w, r6.w  // fAlphaSqr<0:NaN:Inf>
    mul r10.w, r10.w, r10.w
    add r12.y, r12.x, l(-1.000000)
    mul r10.w, r10.w, r12.y
    add r10.w, r10.w, l(1.000000)  // fDenom<0:NaN:Inf>
    mul r12.y, r10.w, l(3.141590)
    mul r10.w, r10.w, r12.y
    div r10.w, r12.x, r10.w  // fD<0:NaN:Inf>

#line 27
    mov r11.w, -r11.w
    add r11.w, r11.w, l(1.000000)
    mul r12.x, r11.w, l(1.000000)
    mul r11.w, r11.w, r11.w
    mul r11.w, r11.w, r11.w
    mul r11.w, r11.w, r12.x  // fDotLH5<0:[0f,1f]>
    mov r12.x, -r7.w
    add r12.x, r12.x, l(1.000000)
    mul r11.w, r11.w, r12.x
    add r7.w, r7.w, r11.w  // fF<0:Inf>
...
#line 3
    ...
    div r12.x, l(1.000000), r12.x  // G1V<0:NaN:Inf>
...
#line 32
    mul r6.w, r6.w, r12.x  // fVis<0:NaN:Inf>
    mul r8.w, r10.w, r8.w
    mul r7.w, r7.w, r8.w
...
#line 310 "lightingconstants.h"
    ...
    mul r12.xyz, r6.wwww, r17.xyzx
    mul r12.xyz, r4.wwww, r12.xyzx
    mul r12.xyz, r5.wwww, r12.xyzx  // f3LightColorSpecularResult<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 461
  ...
  if_nz r4.w
    ld_indexable(buffer)(float,float,float,float) r15.xyz, r2.wwww, t5.xyzw  // f4CenterAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>
    ld_indexable(buffer)(float,float,float,float) r16.xyz, r2.wwww, t6.xyzw  // f3LightCol<0:Inf,1:Inf,2:Inf>
...
#line 168
    ...
    rsq r4.w, r4.w
    mul r21.xyz, r4.wwww, r21.xyzx  // f3EyeVector<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r22.xyz, -r21.xyzx  // f3LightDirSSS<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r15.xyz, r15.xyzx  // f4LightPos<0:Inf,1:Inf,2:Inf>
    mov r15.w, l(1.000000)  // f4LightPos<3: 1f>
    mov r20.xyzw, -r20.xyzw
    add r15.xyzw, r15.xyzw, r20.xyzw
    dp4 r4.w, r15.xyzw, r15.xyzw
    sqrt r4.w, r4.w
    div r4.w, l(1.000000), r4.w
    mul r4.w, r4.w, l(10.000000)  // fAttenuation<0:NaN:Inf>
...
#line 138
    dp3 r5.w, r22.xyzx, r15.xyzx  // fProduct<0:NaN:Inf>
...
#line 176
    mul r20.xyz, r4.wwww, r5.wwww  // f4DotLN<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mov r23.xyz, -r13.xyzx
    dp3 r5.w, r23.xyzx, r22.xyzx
    max r5.w, r5.w, l(0.000000)
    mul r23.xyz, r5.wwww, r18.xxxx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    nop 
...
#line 179
    ...
    mul r23.xyz, r4.wwww, r23.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r24.x, r19.x, r23.x  // f3IndirectLightComponent<0:NaN:Inf>
    mul r24.y, r19.y, r23.y  // f3IndirectLightComponent<1:NaN:Inf>
    mul r24.z, r19.z, r23.z  // f3IndirectLightComponent<2:NaN:Inf>
    mul r19.xyz, r2.wwww, r24.xyzx  // f3IndirectLightComponent<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r2.w, r13.xyzx, r21.xyzx
    max r2.w, r2.w, l(0.000000)
    mov r5.w, -r2.w
    add r21.xyz, r5.wwww, l(1.000000, 1.000000, 1.000000, 0.000000)  // f3Rim<0:Inf:[-1.#INFf,1f],1:Inf:[-1.#INFf,1f],2:Inf:[-1.#INFf,1f]>
    mul r21.xyz, r21.xyzx, r21.xyzx  // f3Rim<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r5.w, r13.xyzx, r22.xyzx
    max r5.w, r5.w, l(0.000000)
    mul r13.xyz, r14.xyzx, r5.wwww
    mul r13.xyz, r13.xyzx, r21.xyzx  // f3Rim<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 146
    ...
    rsq r5.w, r5.w
    mul r17.xyz, r5.wwww, r17.xyzx  // f3HalfAngle<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r5.w, r15.xyzx, r17.xyzx
    max r5.w, r5.w, l(0.000000)
...
#line 520
mul r0.xyz, r2.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // f3AccumDiffuse<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
