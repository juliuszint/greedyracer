...
loop 
  ...
  ult r6.w, r3.w, r6.w
  breakc_z r6.w
  ld_indexable(buffer)(uint,uint,uint,uint) r6.w, r3.wwww, t4.yzwx
  mov r6.w, r6.w  // uLightIndex<0>
...
#line 51
  ld_indexable(buffer)(float,float,float,float) r18.xyzw, r6.wwww, t2.wxyz  // f4CenterAndRadius<3:Inf,0:Inf,1:Inf,2:Inf>
  mov r14.xyz, -r14.xyzx
  add r18.yzw, r14.xxyz, r18.yyzw  // f3ToLight<0:Inf,1:Inf,2:Inf>
  dp3 r7.w, r18.yzwy, r18.yzwy
  rsq r9.w, r7.w
  mul r19.xyz, r9.wwww, r18.yzwy  // f3LightDir<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  sqrt r7.w, r7.w  // fLightDistance<0:NaN:Inf>

#line 62
  mov r18.x, r18.x  // fRad<0:Inf>
  lt r9.w, r7.w, r18.x
  if_nz r9.w
    div r9.w, r7.w, r18.x  // fx<0:NaN:Inf>
...
#line 70
    ...
    div r7.w, r9.w, r7.w  // fFallOff<0:NaN:Inf>
    ld_indexable(buffer)(float,float,float,float) r20.xyz, r6.wwww, t3.xyzw  // f3LightColor<0:Inf,1:Inf,2:Inf>
    dp3 r9.w, r19.xyzx, r15.xyzx
    max r9.w, r9.w, l(0.000000)
    min r9.w, r9.w, l(1.000000)
    mul r21.xyz, r9.wwww, r20.xyzx
    mul r21.xyz, r7.wwww, r21.xyzx  // f3LightColorDiffuseFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 8 "ggxlighting.h"
    ...
    rsq r11.w, r11.w
    mul r22.xyz, r11.wwww, r22.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r9.w, r9.w, r9.w  // fAlpha<0:Inf:[0f,1.#INFf]>
    add r23.xyz, r16.xyzx, r18.yzwy
    dp3 r11.w, r23.xyzx, r23.xyzx
    rsq r11.w, r11.w
    mul r23.xyz, r11.wwww, r23.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r11.w, r22.xyzx, r18.yzwy
    max r11.w, r11.w, l(0.000000)
    min r11.w, r11.w, l(1.000000)  // fDotNL<0:[0f,1f]>
    dp3 r12.w, r22.xyzx, r16.xyzx
    max r12.w, r12.w, l(0.000000)
    min r12.w, r12.w, l(1.000000)  // fDotNV<0:[0f,1f]>
    dp3 r13.w, r22.xyzx, r23.xyzx
    max r13.w, r13.w, l(0.000000)
    min r13.w, r13.w, l(1.000000)  // fDotNH<0:[0f,1f]>
    dp3 r14.w, r18.yzwy, r23.xyzx
    max r14.w, r14.w, l(0.000000)
    min r14.w, r14.w, l(1.000000)  // fDotLH<0:[0f,1f]>

#line 21
    mul r15.w, r9.w, r9.w  // fAlphaSqr<0:NaN:Inf>
    mul r13.w, r13.w, r13.w
    add r16.x, r15.w, l(-1.000000)
    mul r13.w, r13.w, r16.x
    add r13.w, r13.w, l(1.000000)  // fDenom<0:NaN:Inf>
    mul r16.x, r13.w, l(3.141590)
    mul r13.w, r13.w, r16.x
...
#line 27
    ...
    mul r15.w, r14.w, l(1.000000)
    mul r14.w, r14.w, r14.w
    mul r14.w, r14.w, r14.w
    mul r14.w, r14.w, r15.w  // fDotLH5<0:[0f,1f]>
    mov r15.w, -r10.w
    add r15.w, r15.w, l(1.000000)
    mul r14.w, r14.w, r15.w
    add r10.w, r10.w, r14.w  // fF<0:Inf>
...
#line 3
    ...
    div r15.w, l(1.000000), r15.w  // G1V<0:NaN:Inf>
...
#line 32
    mul r9.w, r9.w, r15.w  // fVis<0:NaN:Inf>
...
#line 80 "\\?\C:\Users\admin\Documents\Visual Studio 2010\Projects\Vektoria_2015-02-12a\Vektoria\trunk\VektoriaApp\shaders\Source\transperency.hlsl"
    ...
    mul r16.xyz, r9.wwww, r20.xyzx
    mul r16.xyz, r7.wwww, r16.xyzx  // f3LightColorSpecularFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    max r9.w, r9.w, l(0.000000)
    min r9.w, r9.w, l(1.000000)
    mul r15.xyz, r9.wwww, r20.xyzx
    mul r15.xyz, r7.wwww, r15.xyzx  // f3LightColorDiffuseBackRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 95
    ...
    if_nz r7.w
      ...
      ine r7.w, l(0, 0, 0, 0), cb5[5].z
      if_nz r7.w
        mul r19.xyz, r17.xyzx, l(2.000000, 2.000000, 2.000000, 0.000000)
        mul r20.xyz, r21.xyzx, r16.xyzx
        mul r18.xyz, r19.xyzx, r20.xyzx  // f3LightColorSpecularFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
      else 

#line 100
        mul r17.xyz, r17.xyzx, l(2.000000, 2.000000, 2.000000, 0.000000)
        mul r19.xyz, r21.xyzx, r16.xyzx
        mul r18.xyz, r17.xyzx, r19.xyzx  // f3LightColorSpecularFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 65
    ...
    mov r21.xyz, l(0,0,0,0)  // f3LightColorDiffuseFrontRes<0: 0f,1: 0f,2: 0f>
...
#line 303
  mov r21.xyz, r21.xyzx  // f3LightColorDiffuseFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 307
  ...
  mul r17.xyz, r21.xyzx, r7.wwww
  add r17.xyz, r17.xyzx, r21.xyzx  // f3LightColorDiffuseFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  mul r19.xyz, r15.xyzx, r7.wwww
  add r15.xyz, r15.xyzx, r19.xyzx  // f3LightColorDiffuseBackRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  mul r19.xyz, r18.xyzx, r7.wwww
  add r18.xyz, r18.xyzx, r19.xyzx  // f3LightColorSpecularFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  mul r19.xyz, r16.xyzx, r7.wwww
  add r16.xyz, r16.xyzx, r19.xyzx  // f3LightColorSpecularBackRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  ine r7.w, l(0, 0, 0, 0), cb5[8].z
  if_nz r7.w
    ld_indexable(buffer)(float,float,float,float) r19.xyz, r6.wwww, t2.xyzw  // f4CenterAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>

#line 317
    ld_indexable(buffer)(float,float,float,float) r20.xyz, r6.wwww, t3.xyzw  // f3LightCol<0:Inf,1:Inf,2:Inf>
...
#line 117
  ld_indexable(buffer)(float,float,float,float) r20.xyzw, r3.zzzz, t5.xyzw  // f4BoundingSphereAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>
  ld_indexable(buffer)(float,float,float,float) r21.xyzw, r3.zzzz, t7.wxyz  // f4SpotParams<3:Inf,0:Inf,1:Inf,2:Inf>

#line 121
  mov r22.xy, r21.yzyy  // f3SpotLightDir<0:Inf,1:Inf>
  mul r3.w, r22.x, r22.x
  mov r3.w, -r3.w
  add r3.w, r3.w, l(1.000000)
  mul r4.w, r22.y, r22.y
  mov r4.w, -r4.w
  add r3.w, r3.w, r4.w
  sqrt r3.w, r3.w  // f3SpotLightDir<2:NaN>
  lt r4.w, l(0.000000), r21.w
  mov r5.w, -r3.w
  movc r22.z, r4.w, r3.w, r5.w  // f3SpotLightDir<2:NaN>
  ...
  rsq r5.w, r3.w
  mul r23.xyz, r5.wwww, r20.xyzx  // f3ToLightNorm<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  sqrt r3.w, r3.w  // fLightDistance<0:NaN:Inf>

#line 132
  mov r24.xyz, -r23.xyzx
  dp3 r5.w, r24.xyzx, r22.xyzx  // fCosineOfCurrentConeAngle<0:NaN:Inf>

#line 139
  mov r21.x, r21.x  // fRad<0:Inf>
  mov r6.w, -r21.w
  movc r4.w, r4.w, r21.w, r6.w  // fCosineOfConeAngle<0:Inf>
  lt r6.w, r3.w, r21.x
  lt r7.w, r4.w, r5.w
  and r6.w, r6.w, r7.w
  if_nz r6.w
    ...
    div r4.w, r5.w, r4.w  // fRadialAttenuation<0:NaN:Inf>
    mul r4.w, r4.w, r4.w  // fRadialAttenuation<0:NaN:Inf>
    div r5.w, r3.w, r21.x  // fx<0:NaN:Inf>
...
#line 150
    ...
    mul r3.w, r3.w, r3.w
    add r3.w, r3.w, l(1.000000)
    div r3.w, r5.w, r3.w  // fFallOff<0:NaN:Inf>
    ld_indexable(buffer)(float,float,float,float) r21.xyz, r3.zzzz, t6.xyzw  // f3LightColor<0:Inf,1:Inf,2:Inf>
    dp3 r5.w, r23.xyzx, r17.xyzx
    max r5.w, r5.w, l(0.000000)
    min r5.w, r5.w, l(1.000000)
    mul r22.xyz, r5.wwww, r21.xyzx
    mul r22.xyz, r3.wwww, r22.xyzx
    mul r22.xyz, r4.wwww, r22.xyzx  // f3LightColorDiffuseFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 8 "ggxlighting.h"
    dp3 r7.w, r24.xyzx, r24.xyzx
    rsq r7.w, r7.w
    mul r24.xyz, r7.wwww, r24.xyzx  // f3N<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r5.w, r5.w, r5.w  // fAlpha<0:Inf:[0f,1.#INFf]>
    add r25.xyz, r18.xyzx, r20.xyzx
    dp3 r7.w, r25.xyzx, r25.xyzx
    rsq r7.w, r7.w
    mul r25.xyz, r7.wwww, r25.xyzx  // f3H<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    dp3 r7.w, r24.xyzx, r20.xyzx
    max r7.w, r7.w, l(0.000000)
    min r7.w, r7.w, l(1.000000)  // fDotNL<0:[0f,1f]>
    dp3 r9.w, r24.xyzx, r18.xyzx
    max r9.w, r9.w, l(0.000000)
    min r9.w, r9.w, l(1.000000)  // fDotNV<0:[0f,1f]>
    dp3 r10.w, r24.xyzx, r25.xyzx
    max r10.w, r10.w, l(0.000000)
    min r10.w, r10.w, l(1.000000)  // fDotNH<0:[0f,1f]>
    dp3 r11.w, r20.xyzx, r25.xyzx
    max r11.w, r11.w, l(0.000000)
...
#line 158 "\\?\C:\Users\admin\Documents\Visual Studio 2010\Projects\Vektoria_2015-02-12a\Vektoria\trunk\VektoriaApp\shaders\Source\transperency.hlsl"
    ...
    mul r18.xyz, r5.wwww, r21.xyzx
    mul r18.xyz, r3.wwww, r18.xyzx
    mul r18.xyz, r4.wwww, r18.xyzx  // f3LightColorSpecularFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    ...
    max r5.w, r5.w, l(0.000000)
    min r5.w, r5.w, l(1.000000)
    mul r17.xyz, r5.wwww, r21.xyzx
    mul r17.xyz, r3.wwww, r17.xyzx
    mul r17.xyz, r4.wwww, r17.xyzx  // f3LightColorDiffuseBackRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
    mul r17.xyz, r17.xyzx, cb5[1].yyyy  // f3LightColorDiffuseBackRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>

#line 171
    ine r3.w, l(0, 0, 0, 0), cb5[6].z
    if_nz r3.w
...
#line 143
    ...
    mov r22.xyz, l(0,0,0,0)  // f3LightColorDiffuseFrontRes<0: 0f,1: 0f,2: 0f>
...
#line 358
  mov r22.xyz, r22.xyzx  // f3LightColorDiffuseFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
...
#line 362
  ...
  mul r19.xyz, r22.xyzx, r3.wwww
  add r19.xyz, r19.xyzx, r22.xyzx  // f3LightColorDiffuseFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  mul r21.xyz, r17.xyzx, r3.wwww
  add r17.xyz, r17.xyzx, r21.xyzx  // f3LightColorDiffuseBackRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  mul r21.xyz, r20.xyzx, r3.wwww
  add r20.xyz, r20.xyzx, r21.xyzx  // f3LightColorSpecularFrontRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  mul r21.xyz, r18.xyzx, r3.wwww
  add r18.xyz, r18.xyzx, r21.xyzx  // f3LightColorSpecularBackRes<0:NaN:Inf,1:NaN:Inf,2:NaN:Inf>
  ine r3.w, l(0, 0, 0, 0), cb5[8].z
  if_nz r3.w
    ld_indexable(buffer)(float,float,float,float) r21.xyz, r3.zzzz, t5.xyzw  // f4CenterAndRadius<0:Inf,1:Inf,2:Inf,3:Inf>

#line 372
    ld_indexable(buffer)(float,float,float,float) r22.xyz, r3.zzzz, t6.xyzw  // f3LightCol<0:Inf,1:Inf,2:Inf>
...
ret 
// Approximately 976 instruction slots used
